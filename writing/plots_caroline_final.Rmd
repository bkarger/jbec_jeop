...
```{r}
# table of summary statistics before November 26, 2001
summary_table_before <- kableExtra::kable(jeop_school_summary_before) %>% 
    save_kable("../graphs/summary_before.pdf")
```
...
```{r}
# table of summary statistics after November 26, 2001
summary_table_after_png <- jeop_school_joined %>% 
  kable_as_image(filename = "summary_table_after")

summary_table_after <- kableExtra::kable(jeop_school_summary_after)%>% 
  as_image()
```
